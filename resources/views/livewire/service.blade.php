        ...
        <div class="my-3 p-3 bg-gray-200 rounded-lg shadow-sm">
            <form wire:submit.prevent="store" enctype="multipart/form-data">
                <div class="mb-3 grid grid-cols-12 items-center gap-4">
                    <label for="service_name" class="col-span-2">Service Name</label>
                ...
                <div class="mb-3 grid grid-cols-12 items-center gap-4">
                    <label for="service_desc" class="col-span-2">Service Description</label>
                ...
                <div class="mb-3 grid grid-cols-12 items-center gap-4">
                    <label for="service_img" class="col-span-2">Service Image</label>
                    <div class="col-span-8">
                        <input type="file"
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4">
                                {{-- {{ $service['service_img'] }} --}}
                                <div class="max-w-[200px]">
                                    <span class="truncate block" title="{{ $service['service_img'] }}">{{
                                        Str::limit($service['service_img'], 25, '...') }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
