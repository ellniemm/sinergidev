<script>
    document.getElementById('registerButton').addEventListener('click', async () => {
        ...
        if (!token) {
            showAlert('error', 'Admin authentication required. Please log in.');
            return;
        }
        ...
        try {
            ...
            if (response.ok) {
                const successMessage = result.message || 'User registration successful!';
                ...
                const errorMessage = result.message || 'Failed to register user';
