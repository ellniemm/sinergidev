...
<section class="bg-white py-16 z-10 px-4  w-full">
    ...
    <div class="md:flex md:flex-col justify-center items-center lg:px-24 w-full h-auto relative">
        <div class=" items-center text-black grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto px-4 2xl:px-40">
...
<section class="bg-[#5D82AC] w-full py-16 relative overflow-hidden">
    ...
    <div class="absolute -bottom-[80%] left-0 ">
        <svg class="w-[450px] md:w-[600px]" viewBox="0 0 692 997" viewBox="0 0 692 997" fill="none"
            ...
            <defs>
                <linearGradient id="rectGradient" x1="656.978" y1="829.499" x2="656.978" y2="1204.07"
                    gradientUnits="userSpaceOnUse">
