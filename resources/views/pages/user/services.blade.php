...
<section
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 py-10 w-full">
        @if(isset($services[0]))
        <div class="text-center lg:text-left space-y-4 order-2 lg:order-none">
            <div class="flex flex-col md:flex-row items-center lg:items-start gap-3 py-5">
                <svg width="30" height="30" viewBox="0 0 70 78" fill="none" class="md:w-[50px] md:h-[50px]"
                ...
                <h1 class="text-2xl md:text-4xl 2xl:text-5xl font-semibold text-black">
                    <span class="bg-gradient-to-r from-[#4796A3] to-[#34668f] bg-clip-text text-transparent">
                        {{ $services[0]['service_name'] }}
                    </span>
                </h1>
            </div>
            <div class="text-[#6A6A6A] text-base 2xl:text-xl font-semibold md:whitespace-pre-line md:text-base">
                {{ $services[0]['service_desc'] }}
            </div>
            <div class="flex items-center justify-center lg:justify-start space-x-4">
                <div class="w-2 h-2 bg-black rounded-full"></div>
                <p class="text-black font-semibold text-base md:text-lg 2xl:text-2xl">
                    Backend Technology
                </p>
            </div>
            <div class="flex items-center justify-center lg:justify-start space-x-4">
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 py-20 w-full">
        ...
        <div class="text-left space-y-5 ">
            ...
            <div class="flex flex-col items-center gap-3 py-5">
                <svg width="30" height="30" class="md:w-[50px] md:h-[50px]" viewBox="0 0 70 70" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                ...
                <h1 class="text-2xl md:text-4xl 2xl:text-5xl font-semibold text-black text-center ">
            ...
            <div class="flex items-center justify-center space-x-4">
                <div class="w-2 h-2 bg-black rounded-full text-base md:text-xl"></div>
