...
<header class="bg-[#0D192F] relative py-14 2xl:py-32 md:py-20 ">
    ...
    <div class="container mx-auto text-center px-4 sm:px-6 lg:px-8 py-5 sm:py-10 ">
        <h1
            class="text-2xl sm:text-4xl md:text-5xl 2xl:text-8xl font-bold text-white leading-tight mx-auto max-w-lg md:max-w-3xl 2xl:max-w-7xl">
...
<section
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 py-10 w-full">
        @if(isset($services[0]))
        <div class="text-center lg:text-left  order-2 lg:order-none">
            <div class="flex flex-col md:flex-row items-center lg:items-start gap-3">
            ...
            <div class="text-[#6A6A6A] text-base 2xl:text-xl font-semibold md:whitespace-pre-line md:text-base mb-10">
        ...
        <div class="text-left content-center space-y-5 order-1 lg:order-none">
            <div class="flex justify-center">
                <img src="https://sinergi.dev.ybgee.my.id/img/service/{{ $services[0]['service_img'] }}"
                    class="w-96 2xl:w-5/6 h-72 2xl:h-96 object-cover rounded-lg ">
            </div>
        </div>
        @endif
    </div>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 py-20 w-full">
        ...
        <div class="text-left  ">
            <div class="flex justify-center mb-5">
                <img src="https://sinergi.dev.ybgee.my.id/img/service/{{ $services[1]['service_img'] }}" class="w-96 2xl:w-5/6 h-72 2xl:h-96 items rounded-lg object-cover">
            </div>
            <div class="flex flex-col items-center gap-3 ">
                ...
                <h1 class="text-2xl md:text-3xl 2xl:text-4xl font-semibold text-black text-center ">
        ...
        <div class="text-left ">
            <div class="flex justify-center mb-5">
                <img src="https://sinergi.dev.ybgee.my.id/img/service/{{ $services[2]['service_img'] }}" class="w-96 2xl:w-5/6 h-72 2xl:h-96 items rounded-lg object-cover">
            </div>
            <div class="flex flex-col items-center gap-3 ">
                <svg width="30" height="30" class="md:w-[40px] md:h-[40px]" viewBox="0 0 70 70" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
