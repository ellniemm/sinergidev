...
<header class="bg-[#0D192F] relative py-14 2xl:py-32 md:py-20 ">
    ...
    <div class="relative ">
        {{-- <svg class="-mb-40  hidden lg:block " viewBox="0 0 1728 725" fill="none"
            ...
            <defs>
                ...
                <linearGradient id="paint4_linear_491_77" x1="864" y1="725" x2="864" y2="275"
                    gradientUnits="userSpaceOnUse">
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 py-20 w-full">
        <div class="text-left space-y-5 ">
            ...
            <div class="flex flex-col items-center gap-3 py-5">
                <svg width="30" height="30" class="md:w-[50px] md:h-[50px]" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
