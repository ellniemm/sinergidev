...
<header class="bg-[#0D192F] relative py-14 2xl:py-32 md:py-20 ">
    <div class="container mx-auto text-center px-4 sm:px-6 lg:px-8 py-5 sm:py-10 ">
        <h1
            class="text-2xl sm:text-4xl md:text-5xl 2xl:text-7xl font-bold text-white leading-tight mx-auto max-w-lg md:max-w-3xl 2xl:max-w-7xl">
            Layanan Unggulan untuk Inovasi Bisnis Anda
        </h1>
        <p
            class="text-base py-10 md:text-lg 2xl:text-3xl font-normal text-gray-300 mx-auto mt-7 max-w-sm md:max-w-2xl 2xl:max-w-5xl">
            Dari ide hingga eksekusi, kami membantu Anda menciptakan solusi
            digital yang efektif dan sesuai kebutuhan.
        </p>
    </div>
    <div class="relative ">
        <svg class="-mb-20 md:-mb-40 " viewBox="0 0 1728 725" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
...
<section
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 py-10 w-full">
        @if(isset($services[0]))
    <div class="text-left order-2 md:order-none">
        <div class="flex flex-row items-center justify-center md:items-start md:justify-start gap-3">
            <svg width="30" height="30" viewBox="0 0 70 78" fill="none" class="md:w-[45px] md:h-[45px]"
            ...
            <h1 class="text-2xl md:text-3xl 2xl:text-4xl font-semibold text-black">
                <span class="bg-gradient-to-r from-[#4796A3] to-[#34668f] bg-clip-text text-transparent">
                    {{ $services[0]['service_name'] }}
                </span>
            </h1>
        </div>
        <div class="text-[#6A6A6A] text-base 2xl:text-xl font-semibold md:whitespace-pre-line md:text-base mt-5 md:mt-0 mb-10 px-5 md:px-0 text-center md:text-left">
            {{ $services[0]['service_desc'] }}
        </div>
        <div class="2xl:pt-5 flex justify-center lg:justify-start">
            <a role="button" href="/services/{{ $services[0]['service_id'] }}"
                class="text-black text-sm 2xl:text-xl px-6 py-2 border border-black rounded-full font-medium hover:bg-black hover:text-[#ffffff] transition duration-300">
                Learn More
            </a>
        </div>
    </div>
    <div class="text-left content-center space-y-5 order-1 lg:order-none">
        <div class="flex justify-center">
            <img src="https://sinergi.dev.ybgee.my.id/img/service/{{ $services[0]['service_img'] }}"
                class="w-full max-w-xs md:w-96 2xl:w-5/6 h-64 md:h-72 2xl:h-96 object-cover rounded-lg shadow-md">
        </div>
    </div>
    @endif
    </div>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 py-20 w-full">
        ...
        <div class="text-left  ">
            <div class="flex justify-center mb-5">
                <img src="https://sinergi.dev.ybgee.my.id/img/service/{{ $services[1]['service_img'] }}"
                    class="w-96 2xl:w-5/6 h-72 2xl:h-96 items rounded-lg object-cover">
            </div>
            <div class="flex flex-row md:flex-col items-center gap-2 md:gap-3 ">
                <svg width="30" height="30" class="w-[24px] h-[24px] md:w-[40px] md:h-[40px]" viewBox="0 0 70 70" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                ...
                <h1 class="text-xl md:text-3xl 2xl:text-4xl font-semibold text-black text-center py-3 md:py-0 ">
            ...
            <div
                class="text-[#6A6A6A] text-base 2xl:text-xl font-semibold md:whitespace-pre-line md:text-base text-center mb-10">
                {{ $services[1]['service_desc'] }}
            </div>
            <div class="flex justify-center">
                <a role="button" href="/services/{{ $services[1]['service_id'] }}"
                    class="text-black text-sm 2xl:text-xl px-6 py-2 border border-black rounded-full font-medium hover:bg-black hover:text-[#ffffff] transition duration-300">
                    Learn More
                </a>
            </div>
        ...
        <div class="text-left ">
            <div class="flex justify-center mb-5">
                <img src="https://sinergi.dev.ybgee.my.id/img/service/{{ $services[2]['service_img'] }}"
                    class="w-96 2xl:w-5/6 h-72 2xl:h-96 items rounded-lg object-cover">
            </div>
            <div class="flex flex-row md:flex-col items-center justify-center gap-2 md:gap-3 ">
                <svg width="30" height="30" class="md:w-[40px] md:h-[40px]" viewBox="0 0 70 70" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div
                class="text-[#6A6A6A] text-base 2xl:text-xl font-semibold md:whitespace-pre-line justify-center text-center mb-10">
                {{ $services[2]['service_desc']}}
            </div>
            <div class="flex justify-center">
                <a role="button" href="/services/{{ $services[2]['service_id'] }}"
                    class="text-black text-sm 2xl:text-xl px-6 py-2 border border-black rounded-full font-medium hover:bg-black hover:text-[#ffffff] transition duration-300">
                    Learn More
                </a>
            </div>
