    ...
    <div class="overflow-x-hidden px-1 mx-auto sm:px-10">
        <nav class="text-white mx-auto py-5 flex justify-between items-center">
            ...
            <div class="hidden lg:flex justify-center items-center col-span-6 gap-x-5">
                <a href="{{route('home')}}" class="font-semibold relative cursor-pointer hover:text-blue-300 transition-colors duration-200">
                    Home
                ...
                <a href="{{route('services')}}" class="font-semibold relative cursor-pointer hover:text-blue-300 transition-colors duration-200">
                    Services
                    <span class="absolute -bottom-2 left-0 w-full h-[2px] bg-blue-300 transform origin-left transition-transform duration-200 ease-out scale-x-0"></span>
                </a>
                <a href="{{route('about-us')}}" class="font-semibold relative cursor-pointer hover:text-blue-300 transition-colors duration-200">
                    About Us
                    <span class="absolute -bottom-2 left-0 w-full h-[2px] bg-blue-300 transform origin-left transition-transform duration-200 ease-out scale-x-0"></span>
                </a>
                <a href="{{route('products')}}" class="font-semibold relative cursor-pointer hover:text-blue-300 transition-colors duration-200">
                    Product
                    <span class="absolute -bottom-2 left-0 w-full h-[2px] bg-blue-300 transform origin-left transition-transform duration-200 ease-out scale-x-0"></span>
                </a>
                <a href="#" class="font-semibold relative cursor-pointer hover:text-blue-300 transition-colors duration-200">
                    Blog
                    <span class="absolute -bottom-2 left-0 w-full h-[2px] bg-blue-300 transform origin-left transition-transform duration-200 ease-out scale-x-0"></span>
                </a>
            </div>
