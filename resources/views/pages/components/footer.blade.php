        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 justify-between">
            ...
            <div class="lg:col-span-6">
                ...
                <p class="text-gray-300 leading-relaxed pr-8 text-md 2xl:text-2xl">
                    Menyediakan solusi digital mulai dari pembuatan website, aplikasi mobile, pengembangan game, hingga
                    pemasaran digital, untuk mendukung pertumbuhan bisnis di dunia digital.
                </p>
            </div>
            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <ul class="space-y-2 text-sm 2xl:text-xl text-gray-300">
                    ...
                    <li>
                        <a href="{{ route('blog.user')}}" class="hover:text-blue-400 transition duration-200">
                            Blog
                        </a>
                    </li>
                </ul>
